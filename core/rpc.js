...
function uploadFile(params,callbackUpDate = function () { }, callBackMethod = function () { }) {
  let uri = params.uri;
...
function creatFormData(params) {
  ...
  formdata.append("file", { uri: uri, type: formInput.type, name: encodeURIComponent(formInput.name) });
  return formdata;
}
/**
 * 构造表单对象中file对象
